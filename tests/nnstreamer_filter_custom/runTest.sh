...
if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_passthrough.${SO_EXT}"
else
...
if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL_V="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_passthrough_variable.${SO_EXT}"
else
...
# Test scaler (5, 6, 7)
if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL_S="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_scaler.${SO_EXT}"
else
...
# Test average (8)
if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL_A="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_average.${SO_EXT}"
else
...
if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL_SI="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_scaler_allocator.${SO_EXT}"
else
...
if [ "$TEST_OPENCV" == "YES" ]; then
    if [[ -z "${CUSTOMLIB_DIR}" ]]; then
        PATH_TO_MODEL="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_opencv_scaler.${SO_EXT}"
    else
    ...
    # OpenCV version
    if [[ -z "${CUSTOMLIB_DIR}" ]]; then
        PATH_TO_MODEL_A="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_opencv_average.${SO_EXT}"
    else
...
if [ "$TEST_TENSORRT" == "YES" ]; then
  if [[ -z "${CUSTOMLIB_DIR}" ]]; then
    PATH_TO_MODEL="../../build/tests/nnstreamer_example/libnnstreamer_customfilter_tensorrt_reshape.${SO_EXT}"
  else
