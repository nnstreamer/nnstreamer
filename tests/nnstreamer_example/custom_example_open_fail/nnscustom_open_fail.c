 ...
 * @brief nnstreamer custom filter standard vmethod
 * Refer tensor_filter_custom.h
 * @details Copies each input as it is, which the setInputDim above makes possible.
 *          A case that gives a different number of inputs and outputs is refused
 *          rather than indexed past the end of either array.
 */
static int
