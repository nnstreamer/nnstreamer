...
class NNStreamerFilterFlareCppTest : public ::testing::Test
{
  ...
  void SetUp () override
  {
    ...
    data_file = g_build_filename (root_path, "tests", "test_models", "data", "flare_input.txt", NULL);
...
TEST_F (NNStreamerFilterFlareCppTest, singleInputSingleOutputSync_p)
{
  ...
  gchar *contents = NULL;
  gsize length = 0;
  g_autofree gchar *custom = g_strdup_printf ("tokenizer_path:%s,backend:CPU,output_size:1024,model_type:3B,data_type:W4A32", tokenizer);
...
TEST_F (NNStreamerFilterFlareCppTest, invalidTokenizerPath_n)
{
  ...
  gchar *contents = NULL;
  gsize length = 0;
  g_autofree gchar *custom = g_strdup_printf ("tokenizer_path:invalidTokenizerPath,backend:CPU,output_size:1024,model_type:3B,data_type:W4A32");
