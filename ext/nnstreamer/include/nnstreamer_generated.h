...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<uint32_t> *dimension() const {
    return GetPointer<const flatbuffers::Vector<uint32_t> *>(VT_DIMENSION);
  }
...
struct TensorBuilder {
  ...
  void add_dimension(flatbuffers::Offset<flatbuffers::Vector<uint32_t>> dimension) {
...
inline flatbuffers::Offset<Tensor> CreateTensor(
    ...
    flatbuffers::Offset<flatbuffers::Vector<uint32_t>> dimension = 0,
...
inline flatbuffers::Offset<Tensor> CreateTensorDirect(
    ...
    Tensor_type type = Tensor_type_NNS_END,
    const std::vector<uint32_t> *dimension = nullptr,
    const std::vector<uint8_t> *data = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto dimension__ = dimension ? _fbb.CreateVector<uint32_t>(*dimension) : 0;
