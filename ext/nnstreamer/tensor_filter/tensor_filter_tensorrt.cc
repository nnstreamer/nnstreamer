 ...
 */
tensor_filter_subplugin & tensorrt_subplugin::getEmptyInstance ()
{
 ...
 */
void tensorrt_subplugin::configure_instance (const GstTensorFilterProperties *prop)
{
  /* Set model path */
 ...
 */ 
void tensorrt_subplugin::invoke (const GstTensorMemory *input, GstTensorMemory *output)
{
 ...
 */
void tensorrt_subplugin::getFrameworkInfo (GstTensorFilterFrameworkInfo &info)
{
  info.name = name;
 ...
 */
int tensorrt_subplugin::getModelInfo (model_info_ops ops, GstTensorsInfo &in_info, GstTensorsInfo &out_info)
{
  ...
  gst_tensors_info_copy (std::addressof (in_info),
      std::addressof (_inputTensorMeta));

  gst_tensors_info_copy (std::addressof (out_info),
      std::addressof (_outputTensorMeta));
 ...
 */
int tensorrt_subplugin::eventHandler (event_ops ops, GstTensorFilterFrameworkEventData &data)
{
 ...
 */
int tensorrt_subplugin::loadModel (const GstTensorFilterProperties * prop)
{
 ...
 */
int tensorrt_subplugin::checkUnifiedMemory (void)
{
  int version;
 ...
 */
int tensorrt_subplugin::allocBuffer (void **buffer, gsize size)
{
 ...
 */
int tensorrt_subplugin::setTensorType(tensor_type t)
{
  switch (t) {
    case _NNS_INT32:
 ...
 */
int tensorrt_subplugin::setInputDims(guint input_rank)
{
  switch (input_rank) {
    case 2:
 ...
 */
void tensorrt_subplugin::init_filter_tensorrt (void)
{
 ...
 */
void tensorrt_subplugin::fini_filter_tensorrt (void)
{
  assert (registeredRepresentation != nullptr);
  tensor_filter_subplugin::unregister_subplugin (registeredRepresentation);
}

void _init_filter_tensorrt (void)
{
 tensorrt_subplugin::init_filter_tensorrt (); 
}

void _fini_filter_tensorrt (void)
{
