...
TFLiteCore::checkSharedInterpreter (const GstTensorFilterProperties *prop)
{
  ...
  /* shared model exists */
    ...
    model_path_copy = g_strdup (temp_interpreter->getModelPath ());

    if (g_strcmp0 (prop->model_files[0], model_path_copy) != 0) {
