...
#include <../include/nnstreamer_generated.h>    // Generated by `flatc`.
...
static GstCaps *
fbc_query_caps (const GstTensorConfig * config, GstStructure * st)
{
...
/** @brief tensor converter plugin's NNStreamerExternalConverter callback */
static GstBuffer *
fbc_convert (GstBuffer * buf, gsize * frame_size, guint * frames_in,
    GstTensorsConfig * config)
{
  ...
  /** copy timestamps */
  gst_buffer_copy_into (out_buf, buf, (GstBufferCopyFlags) GST_BUFFER_COPY_METADATA, 0, -1);
