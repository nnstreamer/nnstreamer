...
typedef struct _GstTensorFilterProperties
{
  ...
  GstTensorDataCallback async_callback; /**< The callback function pointer to be called every time the sub-plugin generates a new output tensor asynchronously. */
  void *async_user_data; /**< The user data to be passed to tensor data callback of asynchronous invoke. For 'tensor_filter', this should point to the GstTensorFilter instance. For 'tensor_filter_single', this should be the data pointer provided by the service API. */
